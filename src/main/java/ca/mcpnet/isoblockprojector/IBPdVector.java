...
public class IBPdVector implements org.apache.thrift.TBase<IBPdVector, IBPdVector._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("IBPdVector");
  ...
  static {
    schemes.put(StandardScheme.class, new IBPdVectorStandardSchemeFactory());
    schemes.put(TupleScheme.class, new IBPdVectorTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(IBPdVector.class, metaDataMap);
  }
   ...
   */
  public IBPdVector(IBPdVector other) {
  ...
  public IBPdVector deepCopy() {
    return new IBPdVector(this);
  }
  ...
  public IBPdVector setX(double x) {
    this.x = x;
    setXIsSet(true);
    return this;
  }
  ...
  public IBPdVector setY(double y) {
    this.y = y;
    setYIsSet(true);
    return this;
  }
  ...
  public IBPdVector setZ(double z) {
    this.z = z;
    setZIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof IBPdVector)
      return this.equals((IBPdVector)that);
    return false;
  }

  public boolean equals(IBPdVector that) {
    if (that == null)
      return false;
  ...
  public int compareTo(IBPdVector other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    IBPdVector typedOther = (IBPdVector)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("IBPdVector(");
    boolean first = true;
  ...
  private static class IBPdVectorStandardSchemeFactory implements SchemeFactory {
    public IBPdVectorStandardScheme getScheme() {
      return new IBPdVectorStandardScheme();
    }
  }

  private static class IBPdVectorStandardScheme extends StandardScheme<IBPdVector> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, IBPdVector struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, IBPdVector struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class IBPdVectorTupleSchemeFactory implements SchemeFactory {
    public IBPdVectorTupleScheme getScheme() {
      return new IBPdVectorTupleScheme();
    }
  }

  private static class IBPdVectorTupleScheme extends TupleScheme<IBPdVector> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, IBPdVector struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, IBPdVector struct) throws org.apache.thrift.TException {
