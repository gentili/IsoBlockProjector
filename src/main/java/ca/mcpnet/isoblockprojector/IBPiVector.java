...
public class IBPiVector implements org.apache.thrift.TBase<IBPiVector, IBPiVector._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("IBPiVector");
  ...
  static {
    schemes.put(StandardScheme.class, new IBPiVectorStandardSchemeFactory());
    schemes.put(TupleScheme.class, new IBPiVectorTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(IBPiVector.class, metaDataMap);
  }
   ...
   */
  public IBPiVector(IBPiVector other) {
  ...
  public IBPiVector deepCopy() {
    return new IBPiVector(this);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof IBPiVector)
      return this.equals((IBPiVector)that);
    return false;
  }

  public boolean equals(IBPiVector that) {
    if (that == null)
      return false;
  ...
  public int compareTo(IBPiVector other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    IBPiVector typedOther = (IBPiVector)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("IBPiVector(");
    boolean first = true;
  ...
  private static class IBPiVectorStandardSchemeFactory implements SchemeFactory {
    public IBPiVectorStandardScheme getScheme() {
      return new IBPiVectorStandardScheme();
    }
  }

  private static class IBPiVectorStandardScheme extends StandardScheme<IBPiVector> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, IBPiVector struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, IBPiVector struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class IBPiVectorTupleSchemeFactory implements SchemeFactory {
    public IBPiVectorTupleScheme getScheme() {
      return new IBPiVectorTupleScheme();
    }
  }

  private static class IBPiVectorTupleScheme extends TupleScheme<IBPiVector> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, IBPiVector struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, IBPiVector struct) throws org.apache.thrift.TException {
